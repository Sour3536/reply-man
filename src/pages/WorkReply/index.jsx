			...
			<Section className="pos-rel">
				<MainRow gutter={[{ xl: 32, lg: 16, md: 16 }, 24]} align="top" margintop="0" style={{ paddingTop: '1em' }}>
					<Col lg={6} md={8} id="folder_col">
						...
						<Row>
							<Button type="primary" style={{ height: '70px', width: '100%', fontSize: '22px', borderRadius: '8px' }}>
							...
							<Col
								...
								<Row style={{ margin: '1.5em 0 1em 0' }} align="middle" justify="space-between">
									...
									<Dropdown
										...
										trigger={['click']}
										overlayStyle={{ boxShadow: baseStyles.boxShadow.mild }}>
										<a style={{ fontSize: '17px', marginRight: screenLG ? '0' : '10px', fontWeight: '500' }}>
											Sort By&nbsp;
											<DownOutlined />
										</a>
									</Dropdown>
											...
											<Menu.Item key={index}>
												<ReplyRow justify="space-between">
													<Col xl={19} lg={18} md={19}>
														<Row>
															<Typography.Paragraph
																style={{ marginBottom: '0', fontSize: '20px', fontWeight: '600', lineHeight: '1.4', color: '#606472' }}
																ellipsis={true}>
																{data.title}
															</Typography.Paragraph>
														</Row>
														...
														<Row>
															<SpanForFolder />
															<Typography.Text style={{ fontSize: '17px', color: '#4d505b' }}>{data.folder}</Typography.Text>
														</Row>
													</Col>
													<Col xl={5} lg={6} md={5}>
														{data.favourite ? (
															...
															<Tooltip color="linear-gradient(45deg,#8860d0 ,#8860d0 , #5680e9,#5ab9ea)" title="Add To Favourites">
																<IconSpan>
																	<HeartOutlined
																		style={{ fontSize: '17px', color: '#606472' }}
																		onClick={(e) => {
																			changeFav(index, data);
																			e.stopPropagation();
																		}}
														...
														<span onClick={(e) => e.stopPropagation()}>
															<Popconfirm
																...
																<IconSpan style={{ marginLeft: screenLG ? '2px' : '8px' }}>
																	<DeleteOutlined style={{ fontSize: '17px', color: '#606472' }} />
																</IconSpan>
															</Popconfirm>
														</span>
													</Col>
